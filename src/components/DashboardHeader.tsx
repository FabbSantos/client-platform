    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <motion.h1 
            className="text-2xl font-bold text-tauro-dark"
          ...
          >
            ...
            <div className="flex items-center bg-tauro-gold bg-opacity-10 px-3 py-1 rounded-lg border border-tauro-gold border-opacity-30 justify-center">
